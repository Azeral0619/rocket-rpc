...
class TcpClient : public std::enable_shared_from_this<TcpClient> {
  public:
    ...
    [[nodiscard]] int getConnectErrorCode() const noexcept { return m_connect_error_code; }
    [[nodiscard]] std::string getConnectErrorInfo() const { return m_connect_error_info; }
